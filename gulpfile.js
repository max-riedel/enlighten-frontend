...
gulp.task('fonts', ['fontgen'], function () {
...
gulp.task('compass', function () {
    return gulp.src('src/assets/sass/*.scss')
        ...
        .pipe(cleanCSS())
        .pipe(sourcemaps.write()) // {sourceMappingURL: '/assets/styles/main.css.map'}
...
gulp.task('datify', function () {
    gulp.src('src/index.html')
        .pipe(inject.replace('<!-- inject:buildDate !-->', Date()))
        .pipe(gulp.dest('src/'));
});
...
gulp.task('dev', ['browserify', 'datify'], function () {
    gulp.start('watch');
});
